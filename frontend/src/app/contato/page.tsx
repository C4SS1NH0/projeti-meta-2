        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="lg:col-span-2">
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8">
              <h2 className="text-2xl font-bold text-white mb-6 font-[family-name:var(--font-montserrat)]">
                Envie sua mensagem
              </h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <Button
                  type="submit"
                  className="w-full bg-[#0ea5e9] hover:bg-[#0284c7] text-white py-6 rounded-xl font-bold text-base transition-all flex items-center justify-center gap-2"
                >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-[#0ea5e9] to-[#0284c7] rounded-2xl p-6 text-white">
              ...
              <Button
                className="w-full bg-white text-[#0ea5e9] hover:bg-gray-100 font-bold py-3 rounded-xl"
              >
                Chamar no WhatsApp
              </Button>
            </div>
