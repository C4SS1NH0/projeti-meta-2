          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:border-[#0ea5e9] transition-all group"
                >
                  <div className="w-12 h-12 bg-[#0ea5e9]/20 rounded-xl flex items-center justify-center mb-4 group-hover:bg-[#0ea5e9]/30 transition-all">
